...
<html lang="zh-CN">
	<head>
		...
		<link href="<%=request.getContextPath()%>/css/font-change.css" rel="stylesheet" type="text/css" />
      		...
      		<div class="container">
        		<div class="navbar-header">
					<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" >
	          		...
	          		<a class="navbar-brand" href="index.jsp">深圳市依格欣计算机技术有限公司客户关系管理系统</a>
        		</div>
        		
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a><i class="fa fa-users"></i>欢迎您，${userName}  </a></li>	
						<li><a href="###" onclick="showAtRight('<%=request.getContextPath()%>/sys/userList')"><i class="fa fa-users"></i>  &nbsp;&nbsp;&nbsp;用户列表</a></li>	
						<%-- <li><a href="###" onclick="showAtRight('<%=request.getContextPath()%>/client/productList.jsp')"><i class="fa fa-list-alt"></i> 产品列表</a></li>
						<li><a href="###" onclick="showAtRight('<%=request.getContextPath()%>/client/recordList.jsp')" ><i class="fa fa-list"></i> 订单列表</a></li>	 --%>
					</ul>
				...
				<div class="col-sm-3 col-md-2 sidebar">		
					<ul class="nav nav-sidebar">
						...
						<li class="active"><a href="#userMeun" class="nav-header menu-first collapsed" data-toggle="collapse">
							<i class="fa fa-user"></i>&nbsp; 用户关系管理 <span class="sr-only">(current)</span></a>
						</li> 
						<!-- 二级菜单 -->
						<!-- 注意一级菜单中<a>标签内的href="#……"里面的内容要与二级菜单中<ul>标签内的id="……"里面的内容一致 -->
						<ul id="userMeun" class="nav nav-list collapse menu-second">
							<li><a href="###" onclick="showAtRight('<%=request.getContextPath()%>/sys/userList')"><i class="fa fa-users"></i> 用户关系列表</a></li>
						</ul>
...
<!-- 右侧内容展示==================================================   -->   		
 				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h1 class="page-header"><i class="fa fa-cog fa-spin"></i><small>&nbsp;&nbsp;&nbsp;欢迎使用深圳市依格欣计算机技术有限公司客户关系管理系统</small></h1>
